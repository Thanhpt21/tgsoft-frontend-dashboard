...
import { EditOutlined, DeleteOutlined, MessageOutlined, EyeOutlined, ShopOutlined } from '@ant-design/icons'
        ...
        <div>
          {tenant ? (
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-medium">ID: {tenant.id}</div>
                <div className="text-gray-500 text-xs">{tenant.name}</div>
              </div>
            </div>
          ) : (
