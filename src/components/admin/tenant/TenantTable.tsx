        ...
        <Space size="middle">
          ...
          <Tooltip title="Phân bậc cửa hàng">
            <SettingOutlined
              ...
              onClick={() => {
                setTenantForTier(record)
                setOpenStoreTierModal(true)
              }}
            />
          </Tooltip>
  ...
  return (
    <div>
      ...
      <UserListModalOfTenant
        tenantId={tenantIdForUsers ?? 0}
        visible={openUserModal}
        onClose={() => setOpenUserModal(false)}
      />

      {/* ✅ StoreTierModal - chỉ cần visible, onClose, tenant và onSuccess */}
      <StoreTierModal
        visible={openStoreTierModal}
        onClose={() => {
          setOpenStoreTierModal(false)
          setTenantForTier(null)
        }}
